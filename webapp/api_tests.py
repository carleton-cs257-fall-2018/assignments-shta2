...
class api_tests(unittest.TestCase):
    ...
    def test_transactions_to_candidate_by_contribType();
        assertEquals(get_data('transactions/to_candidate/Maddison?contribType=indiv'), get_data('transactions?max_amount = 20&min_amount=0'))
    ...
    def transactions_by_date_by_recipType():
    ...
    def transactions_by_amount():
        self.assertEquals(get_data('transactions?max_amount=0&min_amount=-400'), [{'date':'2018-06-05', 'amount': -350, 'contribID': 'rm8gcnwothb9',
                     'contribType': 'indiv', 'recipID':'7f5ozph2h', 'recipType': 'cand'}] )
